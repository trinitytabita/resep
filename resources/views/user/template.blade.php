...
<head>
    ...
    <title>@yield('title', 'FoodHut')</title>
    <!-- font icons -->
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <a class="navbar-brand m-auto" href="{{route('admin.login.form')}}">
                <img src="{{asset('images/resep.png')}}" class="brand-img img-circle" alt="">
                <span class="brand-txt">Dapur Resep</span>
            </a>
    ...
    <div class="bg-dark text-light text-center border-top wow fadeIn">
        <p class="mb-0 py-3 text-muted small">&copy; Copyright <script>document.write(new Date().getFullYear())</script> Made with <i class="ti-heart text-danger"></i> By Trinity Tabita</a></p>
    </div>
    <!-- end of page footer -->

	<!-- core  -->
    <script src="{{asset('vendor/jquery/jquery_3_4_1.js')}}"></script>
    <script src="{{asset('vendor/bootstrap/bootstrap.bundle.js')}}"></script>

    <!-- bootstrap affix -->
    <script src="{{asset('vendor/bootstrap/bootstrap.affix.js')}}"></script>
